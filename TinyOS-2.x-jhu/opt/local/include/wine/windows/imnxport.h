/*** Autogenerated by WIDL 1.2.3 from imnxport.idl - Do not edit ***/
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IRangeList : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IIMAPCallback : public ITransportCallback
{
    virtual HRESULT STDMETHODCALLTYPE OnResponse(
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IIMAPTransport : public IInternetTransport
{
    virtual HRESULT STDMETHODCALLTYPE InitNew(
        LPSTR pszLogFilePath,
