/*** Autogenerated by WIDL 1.2.3 from richole.idl - Do not edit ***/

#include <rpc.h>
#include <rpcndr.h>

#ifndef __WIDL_RICHOLE_H
#define __WIDL_RICHOLE_H
...
HRESULT STDMETHODCALLTYPE IRichEditOle_GetClientSite_Proxy(
    IRichEditOle* This,
    LPOLECLIENTSITE *lplpolesite);
void __RPC_STUB IRichEditOle_GetClientSite_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_GetObjectCount_Proxy(
    IRichEditOle* This);
void __RPC_STUB IRichEditOle_GetObjectCount_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_GetLinkCount_Proxy(
    IRichEditOle* This);
void __RPC_STUB IRichEditOle_GetLinkCount_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_GetObject_Proxy(
    IRichEditOle* This,
    LONG iob,
    REOBJECT *lpreobject,
    DWORD dwFlags);
void __RPC_STUB IRichEditOle_GetObject_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_InsertObject_Proxy(
    IRichEditOle* This,
    REOBJECT *lpreobject);
void __RPC_STUB IRichEditOle_InsertObject_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_ConvertObject_Proxy(
    IRichEditOle* This,
    LONG iob,
    REFCLSID rclsidNew,
    LPCSTR lpstrUserTypeNew);
void __RPC_STUB IRichEditOle_ConvertObject_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_ActivateAs_Proxy(
    IRichEditOle* This,
    REFCLSID rclsid,
    REFCLSID rclsidAs);
void __RPC_STUB IRichEditOle_ActivateAs_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_SetHostNames_Proxy(
    IRichEditOle* This,
    LPCSTR lpstrContainerApp,
    LPCSTR lpstrContainerObj);
void __RPC_STUB IRichEditOle_SetHostNames_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_SetLinkAvailable_Proxy(
    IRichEditOle* This,
    LONG iob,
    BOOL fAvailable);
void __RPC_STUB IRichEditOle_SetLinkAvailable_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_SetDvaspect_Proxy(
    IRichEditOle* This,
    LONG iob,
    DWORD dvaspect);
void __RPC_STUB IRichEditOle_SetDvaspect_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_HandsOffStorage_Proxy(
    IRichEditOle* This,
    LONG iob);
void __RPC_STUB IRichEditOle_HandsOffStorage_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_SaveCompleted_Proxy(
    IRichEditOle* This,
    LONG iob,
    LPSTORAGE lpstg);
void __RPC_STUB IRichEditOle_SaveCompleted_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_InPlaceDeactivate_Proxy(
    IRichEditOle* This);
void __RPC_STUB IRichEditOle_InPlaceDeactivate_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_ContextSensitiveHelp_Proxy(
    IRichEditOle* This,
    BOOL fEnterMode);
void __RPC_STUB IRichEditOle_ContextSensitiveHelp_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_GetClipboardData_Proxy(
    IRichEditOle* This,
    CHARRANGE *lpchrg,
    DWORD reco,
    LPDATAOBJECT *lplpdataobj);
void __RPC_STUB IRichEditOle_GetClipboardData_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOle_ImportDataObject_Proxy(
    IRichEditOle* This,
    LPDATAOBJECT lpdataobj,
    CLIPFORMAT cf,
    HGLOBAL hMetaPict);
void __RPC_STUB IRichEditOle_ImportDataObject_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRichEditOleCallback_GetNewStorage_Proxy(
    IRichEditOleCallback* This,
    LPSTORAGE *lplpstg);
void __RPC_STUB IRichEditOleCallback_GetNewStorage_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOleCallback_GetInPlaceContext_Proxy(
    IRichEditOleCallback* This,
    LPOLEINPLACEFRAME *lplpFrame,
    LPOLEINPLACEUIWINDOW *lplpDoc,
    LPOLEINPLACEFRAMEINFO lpFrameInfo);
void __RPC_STUB IRichEditOleCallback_GetInPlaceContext_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOleCallback_ShowContainerUI_Proxy(
    IRichEditOleCallback* This,
    BOOL fShow);
void __RPC_STUB IRichEditOleCallback_ShowContainerUI_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOleCallback_QueryInsertObject_Proxy(
    IRichEditOleCallback* This,
    LPCLSID lpclsid,
    LPSTORAGE lpstg,
    LONG cp);
void __RPC_STUB IRichEditOleCallback_QueryInsertObject_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOleCallback_DeleteObject_Proxy(
    IRichEditOleCallback* This,
    LPOLEOBJECT lpoleobj);
void __RPC_STUB IRichEditOleCallback_DeleteObject_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOleCallback_QueryAcceptData_Proxy(
    IRichEditOleCallback* This,
    LPDATAOBJECT lpdataobj,
    CLIPFORMAT *lpcfFormat,
    DWORD reco,
    BOOL fReally,
    HGLOBAL hMetaPict);
void __RPC_STUB IRichEditOleCallback_QueryAcceptData_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOleCallback_ContextSensitiveHelp_Proxy(
    IRichEditOleCallback* This,
    BOOL fEnterMode);
void __RPC_STUB IRichEditOleCallback_ContextSensitiveHelp_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOleCallback_GetClipboardData_Proxy(
    IRichEditOleCallback* This,
    CHARRANGE *lpchrg,
    DWORD reco,
    LPDATAOBJECT *lplpdataobj);
void __RPC_STUB IRichEditOleCallback_GetClipboardData_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOleCallback_GetDragDropEffect_Proxy(
    IRichEditOleCallback* This,
    BOOL fDrag,
    DWORD grfKeyState,
    LPDWORD pdwEffect);
void __RPC_STUB IRichEditOleCallback_GetDragDropEffect_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IRichEditOleCallback_GetContextMenu_Proxy(
    IRichEditOleCallback* This,
    WORD seltype,
    LPOLEOBJECT lpoleobj,
    CHARRANGE *lpchrg,
    HMENU *lphmenu);
void __RPC_STUB IRichEditOleCallback_GetContextMenu_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
