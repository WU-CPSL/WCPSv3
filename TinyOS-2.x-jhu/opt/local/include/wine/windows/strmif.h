/*** Autogenerated by WIDL 1.2.3 from strmif.idl - Do not edit ***/
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface ISeekingPassThru : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAMFilterMiscFlags : public IUnknown
{
...
typedef struct __WIDL_axextend_generated_name_00000007 {
    DWORD dw1;
    DWORD dw2;
} DDCOLORKEY;
#endif
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRImagePresenter : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRSurfaceAllocator : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRSurfaceAllocatorNotify : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRWindowlessControl : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRMixerControl : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRMonitorConfig : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRFilterConfig : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRAspectRatioControl : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE GetAspectRatioMode(
        DWORD *armode) = 0;
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRDeinterlaceControl : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRMixerBitmap : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRImageCompositor : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRVideoStreamControl : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE SetColorKey(
        DDCOLORKEY *key) = 0;
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRImagePresenterConfig : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE SetRenderingPrefs(
        DWORD prefs) = 0;
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVMRImagePresenterExclModeConfig : public IVMRImagePresenterConfig
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IVPManager : public IUnknown
{
