/*** Autogenerated by WIDL 1.2.3 from hlink.idl - Do not edit ***/
...
typedef enum __WIDL_hlink_generated_name_00000000 {
...
typedef enum __WIDL_hlink_generated_name_00000001 {
    HLINKGETREF_DEFAULT = 0,
    HLINKGETREF_ABSOLUTE = 1,
    HLINKGETREF_RELATIVE = 2
} HLINKGETREF;
typedef enum __WIDL_hlink_generated_name_00000002 {
...
typedef enum __WIDL_hlink_generated_name_00000003 {
    HLINKMISC_RELATIVE = 0x1
} HLINKMISC;
typedef enum __WIDL_hlink_generated_name_00000004 {
...
typedef enum __WIDL_hlink_generated_name_00000005 {
...
HRESULT STDMETHODCALLTYPE IEnumHLITEM_Next_Proxy(
    IEnumHLITEM* This,
    ULONG celt,
    HLITEM *rgelt,
    ULONG *pceltFetched);
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IExtensionServices : public IUnknown
{
