/*** Autogenerated by WIDL 1.2.3 from devicetopology.idl - Do not edit ***/

#include <rpc.h>
#include <rpcndr.h>

#ifndef __WIDL_DEVICETOPOLOGY_H
#define __WIDL_DEVICETOPOLOGY_H
...
interface IKsControl : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IPerChannelDbLevel : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioVolumeLevel : public IPerChannelDbLevel
{
};
#else
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioChannelConfig : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioLoudness : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioInputSelector : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioOutputSelector : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE GetSelection(
        UINT *pnIdSelected) = 0;
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioMute : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioBass : public IPerChannelDbLevel
{
};
#else
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioMidRange : public IPerChannelDbLevel
{
};
#else
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioTreble : public IPerChannelDbLevel
{
};
#else
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioAutoGainControl : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE GetEnabled(
        BOOL bEnabled,
        LPCGUID pguidEventContext) = 0;
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioPeakMeter : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE GetChannelCount(
        UINT *pcChannels) = 0;
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IDeviceSpecificProperty : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IKsFormatSupport : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IKsJackDescription : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IKsJackDescription2 : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE GetJackCount(
        UINT *pcJacks) = 0;
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IKsJackSinkInformation : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IPartsList : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface ISubUnit : public IUnknown
{
};
#else
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IControlInterface : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE GetName(
        LPWSTR *ppwstrName) = 0;
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IControlChangeNotify : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IDeviceTopology : public IUnknown
{
