/*** Autogenerated by WIDL 1.2.3 from activdbg.idl - Do not edit ***/
...
interface IActiveScriptDebug32 : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IActiveScriptDebug64 : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE GetScriptTextAttributes(
        LPCOLESTR pstrCode,
        ULONG uNumCodeChars,
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IDebugApplication64 : public IRemoteDebugApplication
{
    virtual HRESULT STDMETHODCALLTYPE SetName(
        LPCOLESTR pstrName) = 0;
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IActiveScriptSiteDebug64 : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE GetDocumentContextFromPosition(
        DWORDLONG dwSourceContext,
        ULONG uCharacterOffset,
