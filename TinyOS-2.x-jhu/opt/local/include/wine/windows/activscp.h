/*** Autogenerated by WIDL 1.2.3 from activscp.idl - Do not edit ***/
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IActiveScriptParse32 : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IActiveScriptParse64 : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE InitNew(
        ) = 0;
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IActiveScriptParseProcedureOld32 : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IActiveScriptParseProcedureOld64 : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE ParseProcedureText(
        LPCOLESTR pstrCode,
        LPCOLESTR pstrFormalParams,
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IActiveScriptParseProcedure32 : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE ParseProcedureText(
        LPCOLESTR pstrCode,
        LPCOLESTR pstrFormalParams,
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IActiveScriptParseProcedure64 : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE ParseProcedureText(
        LPCOLESTR pstrCode,
        LPCOLESTR pstrFormalParams,
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IActiveScriptParseProcedure2_32 : public IActiveScriptParseProcedure32
{
};
#else
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IActiveScriptParseProcedure2_64 : public IActiveScriptParseProcedure64
{
};
#else
