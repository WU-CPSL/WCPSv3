/*** Autogenerated by WIDL 1.2.3 from endpointvolume.idl - Do not edit ***/

#include <rpc.h>
#include <rpcndr.h>

#ifndef __WIDL_ENDPOINTVOLUME_H
#define __WIDL_ENDPOINTVOLUME_H
...
interface IAudioEndpointVolumeCallback : public IUnknown
{
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IAudioEndpointVolumeEx : public IAudioEndpointVolume
{
