 ...
 *
 * $Id: esp430e.h,v 1.4 2005/03/11 15:49:50 coppice Exp $
 */
...
#define mSET_STARTCURR_INT  (0x0226)  /* Set start current */
#define mSET_STARTCURR_FRAC (0x0228)  /* Set start current */
