...
static   uint8_t StateImplP$State: Exp $getState(
...
static   bool StateImplP$State: Exp $isIdle(
# 67 "/opt/tinyos-2.0/programs/rincon/tos/lib/state/StateImplP.nc"
uint8_t arg_0x1ab568c0);
...
static   void StateImplP$State: Exp $forceState(
# 67 "/opt/tinyos-2.0/programs/rincon/tos/lib/state/StateImplP.nc"
uint8_t arg_0x1ab568c0, 
...
#line 96
static   error_t StateImplP$State: Exp $requestState(uint8_t id, uint8_t reqState);
#line 111
static inline   void StateImplP$State: Exp $forceState(uint8_t id, uint8_t reqState);
...
static inline   bool StateImplP$State: Exp $isIdle(uint8_t id);
...
static inline   uint8_t StateImplP$State: Exp $getState(uint8_t id);
# 10 "/opt/tinyos-2.0/programs/tunit/tos/lib/tunit/TestControl.nc"
...
# 66 "/opt/tinyos-2.0/programs/rincon/tos/lib/state/State.nc"
static   uint8_t TestStateP$State: Exp $getState(void);
#line 56
static   void TestStateP$State: Exp $toIdle(void);




static   bool TestStateP$State: Exp $isIdle(void);
#line 45
static   error_t TestStateP$State: Exp $requestState(uint8_t arg_0x1a926708);





static   void TestStateP$State: Exp $forceState(uint8_t arg_0x1a926c80);
# 10 "/opt/tinyos-2.0/programs/tunit/tos/lib/tunit/TestControl.nc"
...
#line 56
  StateImplP$State: Exp $toIdle(2U);
#line 56
}
#line 56
...
#line 61
  result = StateImplP$State: Exp $isIdle(2U);
#line 61
...
#line 51
  StateImplP$State: Exp $forceState(2U, arg_0x1a926c80);
#line 51
}
#line 51
...
#line 10
# 56 "/opt/tinyos-2.0/programs/rincon/tos/lib/state/State.nc"
inline static   void TestStateP$State: Exp $toIdle(void){
#line 56
...
#line 51
  StateImplP$State: Exp $forceState(4U, arg_0x1a926c80);
#line 51
}
#line 51
inline static   void TUnitP$TUnitState$forceState(uint8_t arg_0x1a926c80){
#line 51
  StateImplP$State: Exp $forceState(3U, arg_0x1a926c80);
#line 51
}
#line 51
...
#line 66
  result = StateImplP$State: Exp $getState(3U);
#line 66
...
#line 45
  result = StateImplP$State: Exp $requestState(4U, arg_0x1a926708);
#line 45
...
#line 12
# 66 "/opt/tinyos-2.0/programs/rincon/tos/lib/state/State.nc"
inline static   uint8_t TestStateP$State: Exp $getState(void){
#line 66
  unsigned char result;
#line 66

#line 66
  result = StateImplP$State: Exp $getState(0U);
#line 66
...
#line 66
#line 51
inline static   void TestStateP$State: Exp $forceState(uint8_t arg_0x1a926c80){
#line 51
  StateImplP$State: Exp $forceState(0U, arg_0x1a926c80);
#line 51
}
#line 51
# 46 "TestStateP.nc"
...
#line 46
{
  TestStateP$State: Exp $forceState(TestStateP$S_STATE1);
  if (!TestStateP$State: Exp $getState() == TestStateP$S_STATE1) {
#line 48
...
#line 48
  ;
  TestStateP$State: Exp $forceState(TestStateP$S_STATE2);
  if (TestStateP$State: Exp $getState() != TestStateP$S_STATE2) {
#line 50
      assertEqualsFailed("TestForce: S_STATE2 not forced correctly", (uint32_t )TestStateP$State: Exp $getState(), (uint32_t )TestStateP$S_STATE2);
    }
  else 
#line 50
    {
...
#line 50
  ;
  TestStateP$State: Exp $forceState(TestStateP$S_IDLE);
  if (TestStateP$State: Exp $getState() == TestStateP$S_STATE3) {
#line 52
...
#line 12
# 61 "/opt/tinyos-2.0/programs/rincon/tos/lib/state/State.nc"
inline static   bool TestStateP$State: Exp $isIdle(void){
#line 61
  unsigned char result;
#line 61

#line 61
  result = StateImplP$State: Exp $isIdle(0U);
#line 61
...
#line 70
{
  TestStateP$State: Exp $forceState(TestStateP$S_STATE3);
  if (!TestStateP$State: Exp $getState() == TestStateP$S_STATE3) {
#line 72
...
#line 72
  ;
  TestStateP$State: Exp $toIdle();
  if (!TestStateP$State: Exp $getState() == TestStateP$S_IDLE) {
#line 74
...
#line 74
  ;
  if (!TestStateP$State: Exp $isIdle()) {
#line 75
...
#line 12
# 45 "/opt/tinyos-2.0/programs/rincon/tos/lib/state/State.nc"
inline static   error_t TestStateP$State: Exp $requestState(uint8_t arg_0x1a926708){
#line 45
  unsigned char result;
#line 45

#line 45
  result = StateImplP$State: Exp $requestState(0U, arg_0x1a926708);
#line 45
...
{
  TestStateP$State: Exp $toIdle();
  TestStateP$State: Exp $requestState(TestStateP$S_STATE1);
  if (!TestStateP$State: Exp $getState() == TestStateP$S_STATE1) {
#line 60
...
#line 60
  ;
  TestStateP$State: Exp $requestState(TestStateP$S_STATE2);
  if (TestStateP$State: Exp $getState() == TestStateP$S_STATE2) {
#line 62
...
#line 62
  ;
  TestStateP$State: Exp $requestState(TestStateP$S_IDLE);
  if (!TestStateP$State: Exp $isIdle()) {
#line 64
...
#line 66
  result = StateImplP$State: Exp $getState(4U);
#line 66
...
#line 61
  result = StateImplP$State: Exp $isIdle(3U);
#line 61
...
#line 56
  StateImplP$State: Exp $toIdle(4U);
#line 56
}
#line 56
...
#line 51
  StateImplP$State: Exp $forceState(1U, arg_0x1a926c80);
#line 51
}
#line 51
...
#line 66
  result = StateImplP$State: Exp $getState(1U);
#line 66
