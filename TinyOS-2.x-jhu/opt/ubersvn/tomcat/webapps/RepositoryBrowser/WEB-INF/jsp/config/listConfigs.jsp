  ...
  <div id="config_confirmation">
    ...
    <c:if test="${latestAddedRepository ne null}">
      <div id="config_success">
        ...
        <p>
          The repository <b>${latestAddedRepository}</b> has been successfully added to RepositoryBrowser.
        </p>
      </div>
    </c:if>
    ...
    <div id="config_faq">
      ...
      <div class="config_faq_entry">
        ...
        <div class="config_faq_answer" id="faqa1" style="display: none;">
          By default, the temporary files created by RepositoryBrowser, including the <b>sventon.log</b> file and
      ...
      <div class="config_faq_entry">
        ...
        <div class="config_faq_answer" id="faqa3" style="display:none;">
          If this RepositoryBrowser instance will be used with <a href="http://tomcat.apache.org/">Tomcat</a> in a
