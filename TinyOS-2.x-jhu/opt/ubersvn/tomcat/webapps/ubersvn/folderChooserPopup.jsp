                   ...
                   /**
		    		...
		    		//
                        ...
                        var newString = dirName.split('\\');
  						...
  						var sOS = window.opener.document.getElementById('serverOS').value;
						//alert(sOS);
						if (sOS == 'Windows'){
        ...
        <webuijsf:form id="folderFormPopup">
          ...
          <webuijsf:contentPageTitle title="#{msgs.folderChooser_title}" id="folderContent">
            <webuijsf:markup tag="div" styleClass="#{themeStyles.CONTENT_MARGIN}">
              ...
              <webuijsf:fileChooser id="folderChooser" lookin="" selected="" sortField="size" descending="true" multiple="false"
                folderChooser="true" />
              <f:verbatim>
                <![CDATA[</td></tr>]]>
              </f:verbatim>
              ...
              <webuijsf:button id="select_folder" text="#{msgs.folderChooser_buttonCaption}" onClick="fnPopulateDir()"
