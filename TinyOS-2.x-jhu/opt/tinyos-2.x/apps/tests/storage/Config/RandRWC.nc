...
implementation {
  ...
  void nextRead() {
    ...
    if (c == NWRITES)
     	...
     	dbg("RandRWC", "Reading %d bytes from addr %d...\n", ops[c].len, ops[c].addr); 
  ...
  void nextWrite() {
    ...
    if (c == NWRITES)
     	...
     	dbg("RandRWC", "Writing %d bytes to addr %d...\n", ops[c].len, ops[c].addr); 
