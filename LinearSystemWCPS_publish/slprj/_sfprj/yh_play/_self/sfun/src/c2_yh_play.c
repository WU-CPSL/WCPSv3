...
static const char * c2_debug_family_names[18] = { "sennum", "step_count", "kk",
  "j", "traces", "nargin", "nargout", "yout", "ydelay", "structure",
  "yout_delay", "trace", "i", "yin_d", "yin", "delay", "yin_all", "num" };

/* Function Declarations */
static void initialize_c2_yh_play(SFc2_yh_playInstanceStruct *chartInstance);
static void initialize_params_c2_yh_play(SFc2_yh_playInstanceStruct
  *chartInstance);
static void enable_c2_yh_play(SFc2_yh_playInstanceStruct *chartInstance);
static void disable_c2_yh_play(SFc2_yh_playInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_yh_play(SFc2_yh_playInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_yh_play(SFc2_yh_playInstanceStruct
  *chartInstance);
static void set_sim_state_c2_yh_play(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_yh_play(SFc2_yh_playInstanceStruct *chartInstance);
static void sf_c2_yh_play(SFc2_yh_playInstanceStruct *chartInstance);
static void initSimStructsc2_yh_play(SFc2_yh_playInstanceStruct *chartInstance);
static void registerMessagesc2_yh_play(SFc2_yh_playInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_b_num, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_b_yin_all, const char_T *c2_identifier, real_T c2_y[100001]);
static void c2_d_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[100001]);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_b_delay, const char_T *c2_identifier, real_T c2_y[9]);
static void c2_f_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[9]);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_g_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_b_yin, const char_T *c2_identifier);
static real_T c2_h_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_i_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_b_yin_d, const char_T *c2_identifier);
static real_T c2_j_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_k_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_b_i, const char_T *c2_identifier);
static real_T c2_l_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_m_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_trace, const char_T *c2_identifier);
static real_T c2_n_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_o_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  c2_struct_1L0b35i9nMnYQagH7Bq10G *c2_y);
static void c2_p_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[153]);
static void c2_q_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
...
static const mxArray *c2_j_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_r_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_i_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_s_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_yh_play, const char_T *c2_identifier);
static uint8_T c2_t_emlrt_marshallIn(SFc2_yh_playInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_yh_playInstanceStruct *chartInstance);
...
static void initialize_c2_yh_play(SFc2_yh_playInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_yh_play = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_struct_1L0b35i9nMnYQagH7Bq10G c2_r0;
  ...
  *chartInstance)
{
  ...
  c2_g_hoistedGlobal = chartInstance->c2_is_active_c2_yh_play;
  ...
  const mxArray *c2_st)
{
  ...
  *c2_yout_delay = c2_m_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c2_is_active_c2_yh_play = c2_s_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 8)), "is_active_c2_yh_play");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_yh_play(chartInstance);
...
static void sf_c2_yh_play(SFc2_yh_playInstanceStruct *chartInstance)
{
  ...
  int32_T c2_i5;
  real_T c2_ydelay[9];
  c2_struct_1L0b35i9nMnYQagH7Bq10G c2_b_structure;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_sennum, 0U, c2_g_sf_marshallOut,
    c2_g_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_step_count, 1U, c2_g_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_kk, 2U, c2_g_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_j, 3U, c2_g_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_traces, 4U, c2_g_sf_marshallOut,
    c2_g_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargin, 5U, c2_g_sf_marshallOut,
    c2_g_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 6U, c2_g_sf_marshallOut,
    c2_g_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_yout_delay, 10U, c2_g_sf_marshallOut,
    c2_g_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_trace, 11U, c2_g_sf_marshallOut,
    c2_g_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c2_i, 12U,
    c2_f_sf_marshallOut, c2_f_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c2_yin_d, 13U,
    c2_e_sf_marshallOut, c2_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c2_yin, 14U,
    c2_d_sf_marshallOut, c2_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(chartInstance->c2_delay, 15U,
    c2_c_sf_marshallOut, c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(chartInstance->c2_yin_all, 16U,
    c2_b_sf_marshallOut, c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c2_num, 17U,
  ...
  if (CV_EML_IF(0, 1, 0, !chartInstance->c2_yin_not_empty)) {
    ...
    chartInstance->c2_yin_d = c2_b_structure.yin_d;
  ...
  for (c2_i8 = 0; c2_i8 < 9; c2_i8++) {
    chartInstance->c2_delay[c2_i8] = c2_ydelay[c2_i8];
  }
  ...
  *c2_b_trace = c2_trace;
  ...
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_yh_playMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u;
  const mxArray *c2_y = NULL;
  SFc2_yh_playInstanceStruct *chartInstance;
  chartInstance = (SFc2_yh_playInstanceStruct *)chartInstanceVoid;
  ...
  *c2_inData)
{
  ...
  for (c2_i9 = 0; c2_i9 < 100001; c2_i9++) {
    c2_b_inData[c2_i9] = (*(real_T (*)[100001])c2_inData)[c2_i9];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_yin_all), &c2_thisId,
                        c2_y);
  sf_mex_destroy(&c2_b_yin_all);
  for (c2_i12 = 0; c2_i12 < 100001; c2_i12++) {
    (*(real_T (*)[100001])c2_outData)[c2_i12] = c2_y[c2_i12];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i13 = 0; c2_i13 < 9; c2_i13++) {
    c2_b_inData[c2_i13] = (*(real_T (*)[9])c2_inData)[c2_i13];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i16 = 0; c2_i16 < 9; c2_i16++) {
    (*(real_T (*)[9])c2_outData)[c2_i16] = c2_y[c2_i16];
  }
...
{
  const mxArray *c2_mxArrayOutData = NULL;
  c2_struct_1L0b35i9nMnYQagH7Bq10G c2_u;
  const mxArray *c2_y = NULL;
  real_T c2_b_u;
  const mxArray *c2_b_y = NULL;
  real_T c2_c_u;
  ...
  chartInstance = (SFc2_yh_playInstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  c2_u = *(c2_struct_1L0b35i9nMnYQagH7Bq10G *)c2_inData;
  c2_y = NULL;
  ...
  for (c2_i17 = 0; c2_i17 < 153; c2_i17++) {
    c2_f_u[c2_i17] = c2_u.delay1[c2_i17];
  }

  c2_f_y = NULL;
  sf_mex_assign(&c2_f_y, sf_mex_create("y", c2_f_u, 0, 0U, 1U, 0U, 2, 51, 3),
                FALSE);
  sf_mex_addfield(c2_y, c2_f_y, "delay1", "delay1", 0);
  for (c2_i18 = 0; c2_i18 < 5; c2_i18++) {
    c2_g_u[c2_i18] = c2_u.ranD[c2_i18];
  }
  ...
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[153])
{
  real_T c2_dv4[153];
  int32_T c2_i19;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv4, 1, 0, 0U, 1, 0U, 2, 51, 3);
  for (c2_i19 = 0; c2_i19 < 153; c2_i19++) {
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  *(c2_struct_1L0b35i9nMnYQagH7Bq10G *)c2_outData = c2_y;
  sf_mex_destroy(&c2_mxArrayInData);
}
  ...
  *c2_inData)
{
  ...
  for (c2_i21 = 0; c2_i21 < 9; c2_i21++) {
    c2_b_inData[c2_i21] = (*(real_T (*)[9])c2_inData)[c2_i21];
  }
...
const mxArray *sf_c2_yh_play_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_yh_play, const char_T *c2_identifier)
{
  ...
  c2_y = c2_t_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_yh_play), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_yh_play);
  return c2_y;
}
...
void sf_c2_yh_play_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(377470607U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3095783372U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2847661845U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1044766922U);
}

mxArray *sf_c2_yh_play_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Wy9jI9UKI6yD7MjT48sgOH");
...
mxArray *sf_c2_yh_play_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_yh_play(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x9'type','srcId','name','auxInfo'{{M[1],M[14],T\"trace\",},{M[1],M[5],T\"yout_delay\",},{M[4],M[0],T\"delay\",S'l','i','p'{{M1x2[341 346],M[0],}}},{M[4],M[0],T\"i\",S'l','i','p'{{M1x2[317 318],M[0],}}},{M[4],M[0],T\"num\",S'l','i','p'{{M1x2[355 358],M[0],}}},{M[4],M[0],T\"yin\",S'l','i','p'{{M1x2[337 340],M[0],}}},{M[4],M[0],T\"yin_all\",S'l','i','p'{{M1x2[347 354],M[0],}}},{M[4],M[0],T\"yin_d\",S'l','i','p'{{M1x2[319 324],M[0],}}},{M[8],M[0],T\"is_active_c2_yh_play\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 9, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_yh_play_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_yh_playInstanceStruct *chartInstance;
    chartInstance = (SFc2_yh_playInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_yh_playMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_yh_playMachineNumber_,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1162);
        _SFD_CV_INIT_EML_IF(0,1,0,473,488,-1,733);
        _SFD_CV_INIT_EML_IF(0,1,1,939,958,1032,1099);
        _SFD_CV_INIT_EML_FOR(0,1,0,821,834,869);
        _SFD_CV_INIT_EML_FOR(0,1,1,925,935,1103);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _yh_playMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "RrLSoZu9zkdXsp065nTfdC";
}

static void sf_opaque_initialize_c2_yh_play(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_yh_playInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c2_yh_play((SFc2_yh_playInstanceStruct*) chartInstanceVar);
  initialize_c2_yh_play((SFc2_yh_playInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_yh_play(void *chartInstanceVar)
{
  enable_c2_yh_play((SFc2_yh_playInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_yh_play(void *chartInstanceVar)
{
  disable_c2_yh_play((SFc2_yh_playInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_yh_play(void *chartInstanceVar)
{
  sf_c2_yh_play((SFc2_yh_playInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_yh_play(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_yh_play((SFc2_yh_playInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_yh_play();/* state var info */
...
extern void sf_internal_set_sim_state_c2_yh_play(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_yh_play((SFc2_yh_playInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_yh_play(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_yh_play(S);
}

static void sf_opaque_set_sim_state_c2_yh_play(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_yh_play(S, st);
}

static void sf_opaque_terminate_c2_yh_play(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_yh_playInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_yh_play_optimization_info();
    }

    finalize_c2_yh_play((SFc2_yh_playInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_yh_play((SFc2_yh_playInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_yh_play(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_yh_play((SFc2_yh_playInstanceStruct*)(((ChartInfoStruct
      *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_yh_play(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_yh_play_optimization_info();
  ...
  ssSetChecksum0(S,(458088892U));
  ssSetChecksum1(S,(177123743U));
  ssSetChecksum2(S,(820173382U));
  ssSetChecksum3(S,(1641356319U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_yh_play(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_yh_play(SimStruct *S)
{
  SFc2_yh_playInstanceStruct *chartInstance;
  chartInstance = (SFc2_yh_playInstanceStruct *)utMalloc(sizeof
    (SFc2_yh_playInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_yh_playInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_yh_play;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_yh_play;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_yh_play;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_yh_play;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_yh_play;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_yh_play;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_yh_play;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_yh_play;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_yh_play;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_yh_play;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_yh_play;
...
void c2_yh_play_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_yh_play(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_yh_play(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_yh_play(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_yh_play_method_dispatcher.\n"
