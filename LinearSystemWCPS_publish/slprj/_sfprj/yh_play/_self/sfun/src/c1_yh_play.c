...
static void initialize_c1_yh_play(SFc1_yh_playInstanceStruct *chartInstance);
static void initialize_params_c1_yh_play(SFc1_yh_playInstanceStruct
  *chartInstance);
static void enable_c1_yh_play(SFc1_yh_playInstanceStruct *chartInstance);
static void disable_c1_yh_play(SFc1_yh_playInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_yh_play(SFc1_yh_playInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_yh_play(SFc1_yh_playInstanceStruct
  *chartInstance);
static void set_sim_state_c1_yh_play(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_yh_play(SFc1_yh_playInstanceStruct *chartInstance);
static void sf_c1_yh_play(SFc1_yh_playInstanceStruct *chartInstance);
static void initSimStructsc1_yh_play(SFc1_yh_playInstanceStruct *chartInstance);
static void registerMessagesc1_yh_play(SFc1_yh_playInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, uint32_T c1_y[15]);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_b_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_b_i, const char_T *c1_identifier);
static real_T c1_c_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_b_delay1, const char_T *c1_identifier, real_T c1_y[9]);
static void c1_e_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_f_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_ymea1, const char_T *c1_identifier);
static real_T c1_g_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_h_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_transpose, const char_T *c1_identifier, real_T c1_y[9]);
static void c1_i_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[9]);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_j_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_k_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_yh_play, const char_T *c1_identifier);
static uint8_T c1_l_emlrt_marshallIn(SFc1_yh_playInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static uint32_T c1_get_ydelay_global(SFc1_yh_playInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_ydelay_global(SFc1_yh_playInstanceStruct *chartInstance,
  uint32_T c1_b, uint32_T c1_c);
static uint32_T *c1_access_ydelay_global(SFc1_yh_playInstanceStruct
  *chartInstance, uint32_T c1_b);
static void init_dsm_address_info(SFc1_yh_playInstanceStruct *chartInstance);
...
static void initialize_c1_yh_play(SFc1_yh_playInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_yh_play = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_c_hoistedGlobal = chartInstance->c1_is_active_c1_yh_play;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_ymea1 = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c1_is_active_c1_yh_play = c1_k_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 4)), "is_active_c1_yh_play");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_yh_play(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  uint32_T c1_u[15];
  const mxArray *c1_y = NULL;
  SFc1_yh_playInstanceStruct *chartInstance;
  chartInstance = (SFc1_yh_playInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_yh_play_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_yh_play, const char_T *c1_identifier)
{
  ...
  c1_y = c1_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_yh_play), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_yh_play);
  return c1_y;
}
...
void sf_c1_yh_play_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_yh_play_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_yh_play_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_yh_play(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"ydelay\",},{M[1],M[7],T\"ymea1\",},{M[4],M[0],T\"delay1\",S'l','i','p'{{M1x2[165 171],M[0],}}},{M[4],M[0],T\"i\",S'l','i','p'{{M1x2[197 198],M[0],}}},{M[8],M[0],T\"is_active_c1_yh_play\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_yh_play_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_yh_playInstanceStruct *chartInstance;
    chartInstance = (SFc1_yh_playInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_yh_play(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_yh_playInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c1_yh_play((SFc1_yh_playInstanceStruct*) chartInstanceVar);
  initialize_c1_yh_play((SFc1_yh_playInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_yh_play(void *chartInstanceVar)
{
  enable_c1_yh_play((SFc1_yh_playInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_yh_play(void *chartInstanceVar)
{
  disable_c1_yh_play((SFc1_yh_playInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_yh_play(void *chartInstanceVar)
{
  sf_c1_yh_play((SFc1_yh_playInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_yh_play(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_yh_play((SFc1_yh_playInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_yh_play();/* state var info */
...
extern void sf_internal_set_sim_state_c1_yh_play(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_yh_play((SFc1_yh_playInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_yh_play(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_yh_play(S);
}

static void sf_opaque_set_sim_state_c1_yh_play(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_yh_play(S, st);
}

static void sf_opaque_terminate_c1_yh_play(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_yh_playInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_yh_play_optimization_info();
    }

    finalize_c1_yh_play((SFc1_yh_playInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_yh_play((SFc1_yh_playInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_yh_play(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_yh_play((SFc1_yh_playInstanceStruct*)(((ChartInfoStruct
      *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_yh_play(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_yh_play(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_yh_play(SimStruct *S)
{
  SFc1_yh_playInstanceStruct *chartInstance;
  chartInstance = (SFc1_yh_playInstanceStruct *)utMalloc(sizeof
    (SFc1_yh_playInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_yh_playInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_yh_play;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_yh_play;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_yh_play;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_yh_play;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_yh_play;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_yh_play;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_yh_play;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_yh_play;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_yh_play;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_yh_play;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_yh_play;
...
void c1_yh_play_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_yh_play(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_yh_play(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_yh_play(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_yh_play_method_dispatcher.\n"
